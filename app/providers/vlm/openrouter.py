...
Selected garments (must be faithfully rendered, not substituted): {expected_desc}"""
    ...
    _SOFT_FIELD_PROMPTS: Dict[str, str] = {
        ...
        "fit": '"fit": "slim | regular | oversized | relaxed | tailored | loose | tight | not_applicable"',
        "silhouette": '"silhouette": "straight | a_line | fitted | boxy | hourglass | tapered | flared | asymmetrical | draped | not_applicable"',
